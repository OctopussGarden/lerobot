...
Keyboard control is identical to 5_SO101_keyboard_ee_control.py
...
def p_control_loop(
    ...
    """
    P control loop - identical to 5_SO101_keyboard_ee_control.py
...
def main():
    ...
    try:
        ...
        arm_id = "left_arm" if port.endswith("ACM0") else "right_arm"
        
        # Configure robot
        robot_config = SO101FollowerConfig(port=port, id=arm_id)
