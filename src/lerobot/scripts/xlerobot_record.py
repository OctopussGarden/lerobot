...
from lerobot.teleoperators.xlerobot_joycon.xlerobot_joycon import XLerobotJoyconTeleop, init_joycon_listener
...
def record_loop(
    ...
    while timestamp < control_time_s:
        ...
        current_events = teleop.get_joycon_events()
        ...
        if events["reset_position"]:
            ...
            action = teleop.move_to_zero_position(robot)
            teleop.joycon_event_handler.events['reset_position'] = False
            ...
            teleop.joycon_event_handler.events['back_position'] = False
...
def record(cfg: RecordConfig) -> LeRobotDataset:
    ...
    if isinstance(teleop, XLerobotJoyconTeleop):
        # Use joycon listener
        listener, events = init_joycon_listener(teleop)
        logging.info("🎮 Using Joycon to control recording status")
    else:
    ...
    with VideoEncodingManager(dataset):
        ...
        while recorded_episodes < cfg.dataset.num_episodes and not events["stop_recording"]:
            ...
            if events["rerecord_episode"]:
                ...
                events["exit_early"] = False
                teleop.joycon_event_handler.events['rerecord_episode'] = False
